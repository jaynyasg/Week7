...
namespace CareerQuest.Tests
{
    public class ShowcaseSequenceTests
    {
        ...
        public void DefaultShowcaseSequenceContainsRequiredBeatsInOrder()
        {
            ...
            Assert.That(presenter.Steps[2].Id, Is.EqualTo("build"));
            Assert.That(presenter.Steps[3].Id, Is.EqualTo("gallery"));
            Assert.That(presenter.Steps[4].Id, Is.EqualTo("reveal"));
